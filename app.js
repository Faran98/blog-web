...
app.get("/posts/:postname", function (req, res) {
  ...
  postname = _.lowerCase(req.params.postname);
  posts.forEach(function (post) {
    const staoredtitle = _.lowerCase(post.posttitle);

    if (postname === staoredtitle) {
      res.render("post",{title : post.posttitle , content : post.postpara});
